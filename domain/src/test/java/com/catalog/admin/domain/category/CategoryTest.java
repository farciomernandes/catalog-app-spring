...
public class CategoryTest {
    ...
    @Test
    public void givenAnInvalidNameLengthMoreThen255_whenCallNewCategoryAnValidate_thenShouldReceiveError(){
        final String expectedErrorMessage = "'name' must be between 3 and 255 characters";
        final var expectedErrorCount = 1;
        final String expectedName = "No entanto, não podemos esquecer que a hegemonia do ambiente político deve passar por " +
                "modificações independentemente dos níveis de motivação departamental. Assim mesmo, a execução dos pontos " +
                "do programa possibilita uma melhor visão global dos relacionamentos verticais entre as hierarquias.";
        final var expectedDescription = "A categoria mais assistida";
        final var expectedIsActive = true;
